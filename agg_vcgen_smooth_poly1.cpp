...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    void vcgen_smooth_poly1::add_vertex(float64 x, float64 y, unsigned cmd)
    {
        m_status = initial;
        if(is_move_to(cmd))
        {
                                       ...
                                       const vertex_dist& v3)
    {
        ...
        float64 k1 = v0.dist / (v0.dist + v1.dist);
        float64 k2 = v1.dist / (v1.dist + v2.dist);

        float64 xm1 = v0.x + (v2.x - v0.x) * k1;
        float64 ym1 = v0.y + (v2.y - v0.y) * k1;
        float64 xm2 = v1.x + (v3.x - v1.x) * k2;
        float64 ym2 = v1.y + (v3.y - v1.y) * k2;
    ...
    //------------------------------------------------------------------------
    unsigned vcgen_smooth_poly1::vertex(float64* x, float64* y)
    {
