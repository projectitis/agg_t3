...
namespace agg
{
    ...
    struct ras_conv_int
    {
        ...
        static AGG_INLINE int mul_div(float64 a, float64 b, float64 c)
        {
            return iround(a * b / c);
        }
        static int xi(int v) { return v; }
        static int yi(int v) { return v; }
        static int upscale(float64 v) { return iround(v * poly_subpixel_scale); }
    ...
    struct ras_conv_dbl
    {
        typedef float64 coord_type;
        static AGG_INLINE float64 mul_div(float64 a, float64 b, float64 c)
        {
            return a * b / c;
        }
        static int xi(float64 v) { return iround(v * poly_subpixel_scale); }
        static int yi(float64 v) { return iround(v * poly_subpixel_scale); }
        static float64 upscale(float64 v) { return v; }
        static float64 downscale(int v)  { return v / float64(poly_subpixel_scale); }
    };
    ...
    struct ras_conv_dbl_3x
    {
        ...
        static int xi(float64 v) { return iround(v * poly_subpixel_scale * 3); }
        static int yi(float64 v) { return iround(v * poly_subpixel_scale); }
        static float64 upscale(float64 v) { return v; }
        static float64 downscale(int v)  { return v / float64(poly_subpixel_scale); }
    };
