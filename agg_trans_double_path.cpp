...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    trans_float64_path::trans_float64_path() :
        m_kindex1(0.0),
        m_kindex2(0.0),
        m_base_length(0.0),
        m_base_height(1.0),
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::move_to1(float64 x, float64 y)
    {
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::line_to1(float64 x, float64 y)
    {
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::move_to2(float64 x, float64 y)
    {
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::line_to2(float64 x, float64 y)
    {
    ...
    //------------------------------------------------------------------------
    float64 trans_float64_path::finalize_path(vertex_storage& vertices)
    {
        unsigned i;
        float64 dist;
        float64 d;
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::finalize_paths()
    {
    ...
    //------------------------------------------------------------------------
    float64 trans_float64_path::total_length1() const
    {
    ...
    //------------------------------------------------------------------------
    float64 trans_float64_path::total_length2() const
    {
        if(m_base_length >= 1e-10) return m_base_length;
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::transform1(const vertex_storage& vertices, 
    ...
    //------------------------------------------------------------------------
    void trans_float64_path::transform(float64 *x, float64 *y) const
    {
        if(m_status1 == ready && m_status2 == ready)
        {
            ...
            float64 x2 = *x;
            float64 y2 = *y;
            float64 dd = m_src_vertices2[m_src_vertices2.size() - 1].dist /
                        m_src_vertices1[m_src_vertices1.size() - 1].dist;
