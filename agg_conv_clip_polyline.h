...
namespace agg
{
    ...
    struct conv_clip_polyline : public conv_adaptor_vpgen<VertexSource, vpgen_clip_polyline>
    {
        ...
        float64 x1() const { return base_type::vpgen().x1(); }
        float64 y1() const { return base_type::vpgen().y1(); }
        float64 x2() const { return base_type::vpgen().x2(); }
        float64 y2() const { return base_type::vpgen().y2(); }
