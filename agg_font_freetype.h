...
namespace agg
{
    ...
    public:
        ...
        bool height(float64 h);
        bool width(float64 w);
        void hinting(bool h);
        void flip_y(bool f);
        ...
        float64      height()       const { return float64(m_height) / 64.0;    }
        float64      width()        const { return float64(m_width) / 64.0;     }
        float64      ascender()     const;
        float64      descender()    const;
        ...
        float64          advance_x()   const { return m_advance_x;   }
        float64          advance_y()   const { return m_advance_y;   }
