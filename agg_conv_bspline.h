...
namespace agg
{
    ...
    struct conv_bspline : public conv_adaptor_vcgen<VertexSource, vcgen_bspline>
    {
        ...
        void   interpolation_step(float64 v) { base_type::generator().interpolation_step(v); }
        float64 interpolation_step() const { return base_type::generator().interpolation_step(); }
