...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    void arc::init(float64 x,  float64 y, 
                   float64 rx, float64 ry, 
                   float64 a1, float64 a2, 
                   bool ccw)
    {
    ...
    //------------------------------------------------------------------------
    void arc::approximation_scale(float64 s)
    {
        m_scale = s;
        if(m_initialized)
        {
    ...
    //------------------------------------------------------------------------
    unsigned arc::vertex(float64* x, float64* y)
    {
    ...
    //------------------------------------------------------------------------
    void arc::normalize(float64 a1, float64 a2, bool ccw)
    {
