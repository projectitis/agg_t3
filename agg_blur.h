...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        template<class Img> void blur_x(Img& img, float64 radius)
        {
        ...
        //--------------------------------------------------------------------
        template<class Img> void blur_y(Img& img, float64 radius)
        {
            pixfmt_transposer<Img> img2(img);
            blur_x(img2, radius);
        }
        ...
        //--------------------------------------------------------------------
        template<class Img> void blur(Img& img, float64 radius)
        {
            blur_x(img, radius);
            pixfmt_transposer<Img> img2(img);
            blur_x(img2, radius);
    ...
    template<class T=float64> struct recursive_blur_calc_rgba
    {
        typedef T value_type;
    ...
    template<class T=float64> struct recursive_blur_calc_rgb
    {
        typedef T value_type;
    ...
    template<class T=float64> struct recursive_blur_calc_gray
    {
        typedef T value_type;
    ...
    template<class PixFmt>
    void apply_slight_blur(PixFmt& img, const rect_i& bounds, float64 r = 1)
    {
        if (r > 0) slight_blur<PixFmt>(r).blur(img, bounds);
    }

    template<class PixFmt>
    void apply_slight_blur(PixFmt& img, float64 r = 1)
    {
        if (r > 0) slight_blur<PixFmt>(r).blur(img, rect_i(0, 0, img.width() - 1, img.height() - 1));
    }

    template<class PixFmt>
    void apply_slight_blur(renderer_base<PixFmt>& img, const rect_i& bounds, float64 r = 1)
    {
        if (r > 0) slight_blur<PixFmt>(r).blur(img.ren(), bounds);
    }

    template<class PixFmt>
    void apply_slight_blur(renderer_base<PixFmt>& img, float64 r = 1)
    {
