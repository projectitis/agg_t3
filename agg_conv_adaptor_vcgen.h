...
namespace agg
{
    ...
    {
        void remove_all() {}
        void add_vertex(float64, float64, unsigned) {}
        void prepare_src() {}

        void rewind(unsigned) {}
        unsigned vertex(float64*, float64*) { return path_cmd_stop; }
    };
    ...
    unsigned conv_adaptor_vcgen<VertexSource, Generator, Markers>::vertex(float64* x, float64* y)
    {
