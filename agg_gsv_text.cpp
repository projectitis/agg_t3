...
namespace agg
{
    ...
    //-------------------------------------------------------------------------
    void gsv_text::size(float64 height, float64 width)
    {
        m_height = height;
        m_width  = width;
    }
    ...
    //-------------------------------------------------------------------------
    void gsv_text::space(float64 space)
    {
        m_space = space;
    }

    //-------------------------------------------------------------------------
    void gsv_text::line_space(float64 line_space)
    {
        m_line_space = line_space;
    }

    //-------------------------------------------------------------------------
    void gsv_text::start_point(float64 x, float64 y)
    {
        m_x = m_start_x = x;
        m_y = y;
    ...
    void gsv_text::rewind(unsigned)
    {
        ...
        float64 base_height = value(m_indices + 4);
    ...
    //-------------------------------------------------------------------------
    unsigned gsv_text::vertex(float64* x, float64* y)
    {
        unsigned idx;
        int8 yc, yf;
        int dx, dy;
