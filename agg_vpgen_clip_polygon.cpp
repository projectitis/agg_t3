...
namespace agg
{
    ...
    //
    // 
    unsigned vpgen_clip_polygon::clipping_flags(float64 x, float64 y)
    {
        if(x < m_clip_box.x1) 
        {
    ...
    //----------------------------------------------------------------------------
    void vpgen_clip_polygon::move_to(float64 x, float64 y)
    {
        m_vertex = 0;
        m_num_vertices = 0;
    ...
    //----------------------------------------------------------------------------
    void vpgen_clip_polygon::line_to(float64 x, float64 y)
    {
        m_vertex = 0;
        m_num_vertices = 0;
    ...
    //----------------------------------------------------------------------------
    unsigned vpgen_clip_polygon::vertex(float64* x, float64* y)
    {
