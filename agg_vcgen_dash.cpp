...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    void vcgen_dash::add_dash(float64 dash_len, float64 gap_len)
    {
    ...
    //------------------------------------------------------------------------
    void vcgen_dash::dash_start(float64 ds)
    {
        m_dash_start = ds;
    ...
    //------------------------------------------------------------------------
    void vcgen_dash::calc_dash_start(float64 ds)
    {
        m_curr_dash = 0;
        m_curr_dash_start = 0.0;
        while(ds > 0.0)
    ...
    //------------------------------------------------------------------------
    void vcgen_dash::add_vertex(float64 x, float64 y, unsigned cmd)
    {
        m_status = initial;
        if(is_move_to(cmd))
        {
    ...
    //------------------------------------------------------------------------
    unsigned vcgen_dash::vertex(float64* x, float64* y)
    {
        ...
        while(!is_stop(cmd))
        {
            ...
            case polyline:
                {
                    float64 dash_rest = m_dashes[m_curr_dash] - m_curr_dash_start;
