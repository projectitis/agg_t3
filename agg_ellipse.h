...
namespace agg
{
    ...
    public:
        ...
        ellipse(float64 x, float64 y, float64 rx, float64 ry, 
        ...
        void init(float64 x, float64 y, float64 rx, float64 ry, 
                  unsigned num_steps=0, bool cw=false);

        void approximation_scale(float64 scale);
    ...
    //------------------------------------------------------------------------
    inline void ellipse::init(float64 x, float64 y, float64 rx, float64 ry, 
    ...
    //------------------------------------------------------------------------
    inline void ellipse::approximation_scale(float64 scale)
    {   
        m_scale = scale;
        calc_num_steps();
    }
    ...
    {
        float64 ra = (fabs(m_rx) + fabs(m_ry)) / 2;
        float64 da = acos(ra / (ra + 0.125 / m_scale)) * 2;
    ...
    //------------------------------------------------------------------------
    inline unsigned ellipse::vertex(float64* x, float64* y)
    {
        if(m_step == m_num) 
        {
            ++m_step;
        ...
        float64 angle = float64(m_step) / float64(m_num) * 2.0 * pi;
