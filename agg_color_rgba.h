...
namespace agg
{
    ...
    struct rgba
    {
        ...
        //--------------------------------------------------------------------
        rgba(float64 r_, float64 g_, float64 b_, float64 a_=1.0) :
            r(r_), g(g_), b(b_), a(a_) {}

        //--------------------------------------------------------------------
        rgba(const rgba& c, float64 a_) : r(c.r), g(c.g), b(c.b), a(a_) {}
        ...
        //--------------------------------------------------------------------
        rgba gradient(rgba c, float64 k) const
        {
            rgba ret;
            ret.r = r + (c.r - r) * k;
            ret.g = g + (c.g - g) * k;
		...
		/*
        //--------------------------------------------------------------------
        static rgba from_wavelength(float64 wl, float64 gamma = 1.0);
    
        //--------------------------------------------------------------------
        explicit rgba(float64 wavelen, float64 gamma=1.0)
        {
    ...
    inline rgba operator*(const rgba& a, float64 b)
    {
        return rgba(a) *= b;
    }
	...
	/*
    //------------------------------------------------------------------------
    inline rgba rgba::from_wavelength(float64 wl, float64 gamma)
    {
        rgba t(0.0, 0.0, 0.0);
	...
	*/
    ...
    inline rgba rgba_pre(float64 r, float64 g, float64 b, float64 a)
    {
    ...
    struct rgba8T
    {
        ...
        //--------------------------------------------------------------------
        static AGG_INLINE float64 to_float64(value_type a)
        {
            return float64(a) / base_mask;
        }

        //--------------------------------------------------------------------
        static AGG_INLINE value_type from_float64(float64 a)
        {
        ...
        //--------------------------------------------------------------------
        self_type& opacity(float64 a_)
        {
            if (a_ < 0) a = 0;
            else if (a_ > 1) a = 1;
            else a = (value_type)uround(a_ * float64(base_mask));
            return *this;
        }
        ...
        float64 opacity() const
        {
            return float64(a) / float64(base_mask);
        }
        ...
        //--------------------------------------------------------------------
        AGG_INLINE self_type gradient(const self_type& c, float64 k) const
        {
            self_type ret;
		...
		*/
		...
		/*
        //--------------------------------------------------------------------
        static self_type from_wavelength(float64 wl, float64 gamma = 1.0)
        {
	...
	*/
    ...
    struct rgba16
    {
        ...
        //--------------------------------------------------------------------
        rgba16(const rgba& c) :
            r((value_type)uround(c.r * float64(base_mask))), 
            g((value_type)uround(c.g * float64(base_mask))), 
            b((value_type)uround(c.b * float64(base_mask))), 
            a((value_type)uround(c.a * float64(base_mask))) {}
        ...
        //--------------------------------------------------------------------
        AGG_INLINE self_type& opacity(float64 a_)
        {
            if (a_ < 0) a = 0;
            if (a_ > 1) a = 1;
            a = value_type(uround(a_ * float64(base_mask)));
            return *this;
        }
	...
	*/
    ...
    struct rgba32
    {
        ...
        typedef float64 calc_type;
        typedef float64 long_type;
		...
		*/
		...
		/*
        //--------------------------------------------------------------------
        static self_type from_wavelength(float64 wl, float64 gamma = 1)
        {
            return self_type(rgba::from_wavelength(wl, gamma));
        }
		*/
