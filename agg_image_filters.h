...
namespace agg
{
    ...
    public:
                                               ...
                                               bool normalization=true)
        {
            ...
            float64 r = filter.radius();
            realloc_lut(r);
            unsigned i;
            unsigned pivot = diameter() << (image_subpixel_shift - 1);
            for(i = 0; i < pivot; i++)
            {
                float64 x = float64(i) / float64(image_subpixel_scale);
                float64 y = filter.calc_weight(x);
    ...
    private:
        void realloc_lut(float64 radius);
    ...
    {
        static float64 radius() { return 1.0; }
        static float64 calc_weight(float64 x)
        {
            return 1.0 - x;
        }
    };
    ...
    {
        static float64 radius() { return 1.5; }
        static float64 calc_weight(float64 x)
        {
            float64 t;
    ...
    {
        static float64 pow3(float64 x)
        {
            return (x <= 0.0) ? 0.0 : x * x * x;
        }

    public:
        static float64 radius() { return 2.0; }
        static float64 calc_weight(float64 x)
        {
            return
                (1.0/6.0) * 
    ...
    public:
        image_filter_kaiser(float64 b = 6.33) :
            a(b), epsilon(1e-12)
        {
            i0a = 1.0 / bessel_i0(b);
        }
        ...
        static float64 radius() { return 1.0; }
        float64 calc_weight(float64 x) const
        {
            return bessel_i0(a * sqrt(1. - x * x)) * i0a;
        }

    private:
        float64 bessel_i0(float64 x) const
        {
            int i;
            float64 sum, y, t;
    ...
    public:
        image_filter_mitchell(float64 b = 1.0/3.0, float64 c = 1.0/3.0) :
            p0((6.0 - 2.0 * b) / 6.0),
    ...
    {
        static float64 radius() { return 3.0; }
        static float64 calc_weight(float64 x)
        {
           if(x < 1.0)
           {
    ...
    {
        static float64 radius() { return 3.2383; } 
        static float64 calc_weight(float64 x)
        {
    ...
    {
    public:
        image_filter_sinc(float64 r) : m_radius(r < 2.0 ? 2.0 : r) {}
        float64 radius() const { return m_radius; }
        float64 calc_weight(float64 x) const
        {
            if(x == 0.0) return 1.0;
    ...
    {
    public:
        image_filter_lanczos(float64 r) : m_radius(r < 2.0 ? 2.0 : r) {}
        float64 radius() const { return m_radius; }
        float64 calc_weight(float64 x) const
        {
           if(x == 0.0) return 1.0;
    ...
    {
    public:
        image_filter_blackman(float64 r) : m_radius(r < 2.0 ? 2.0 : r) {}
        float64 radius() const { return m_radius; }
        float64 calc_weight(float64 x) const
        {
           if(x == 0.0) return 1.0;
