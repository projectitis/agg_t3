...
namespace agg
{
    ...
    public:
        ...
        void size(float64 height, float64 width=0.0);
        void space(float64 space);
        void line_space(float64 line_space);
        void start_point(float64 x, float64 y);
