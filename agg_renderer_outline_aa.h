...
namespace agg
{
    ...
    public:
        ...
        //---------------------------------------------------------------------
        void min_width(float64 w) { m_min_width = w; }
        void smoother_width(float64 w) { m_smoother_width = w; }
        ...
        //---------------------------------------------------------------------
        float64 min_width() const { return m_min_width; }
        float64 smoother_width() const { return m_smoother_width; }
    ...
    private:
        ...
        value_type* profile(float64 w);
        void set(float64 center_width, float64 smoother_width);
