...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        float64 height()    const { return m_font[0]; }
        float64 base_line() const { return m_font[1]; }

        //--------------------------------------------------------------------
        template<class CharT>
        float64 width(const CharT* str) const
        {
        ...
        //--------------------------------------------------------------------
        void prepare(glyph_rect* r, float64 x, float64 y, unsigned glyph, bool flip)
        {
            unsigned start_char = m_font[2];
            unsigned num_chars = m_font[3];
