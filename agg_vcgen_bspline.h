...
namespace agg
{
    ...
    public:
        ...
        void interpolation_step(float64 v) { m_interpolation_step = v; }
        float64 interpolation_step() const { return m_interpolation_step; }
    ...
    private:
        ...
        bspline        m_spline_x;
        bspline        m_spline_y;
        float64         m_interpolation_step;
        unsigned       m_closed;
        status_e       m_status;
        unsigned       m_src_vertex;
        float64         m_cur_abscissa;
        float64         m_max_abscissa;
    };
