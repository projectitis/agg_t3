...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    void trans_single_path::move_to(float64 x, float64 y)
    {
        if(m_status == initial)
        {
    ...
    //------------------------------------------------------------------------
    void trans_single_path::line_to(float64 x, float64 y)
    {
    ...
    //------------------------------------------------------------------------
    float64 trans_single_path::total_length() const
    {
    ...
    //------------------------------------------------------------------------
    void trans_single_path::transform(float64 *x, float64 *y) const
    {
        if(m_status == ready)
        {
            ...
            float64 x2 = x1 + dx * d / dd;
            float64 y2 = y1 + dy * d / dd;
            *x = x2 - *y * dy / dd;
            *y = y2 + *y * dx / dd;
        }
    }
